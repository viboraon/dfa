...
local function reanimate()
	...
	local walkSpeed = 60 --your walkspeed (can be changed at runtime)
...
RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(1,0.5,0),angles(0.2617993877991494+0.05235987755982989*sin((sine+3)*3),1.5707963267948966,0)),deltaTime)  LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-1,0.5,0),angles(0.2617993877991494+0.03490658503988659*sin((sine+3)*3),-1.5707963267948966,0)),deltaTime)  RootJoint.C0=Lerp(RootJoint.C0,cfMul(cf(0.3+0.3*sin((sine+1)*1),2+0.5*sin((sine+2)*2),0.3+0.3*sin((sine+1)*1)),angles(-1.7453292519943295+0.08726646259971647*sin((sine+2)*2),0,3.141592653589793)),deltaTime)  LeftHip.C0=Lerp(LeftHip.C0,cfMul(cf(-1,-1,0),angles(0,-1.5707963267948966,0)),deltaTime)  Neck.C0=Lerp(Neck.C0,cfMul(cf(0,1,0),angles(-1.5707963267948966+0.17453292519943295*sin((sine+5)*1),0,3.141592653589793)),deltaTime)  RightHip.C0=Lerp(RightHip.C0,cfMul(cf(1,-1,0),angles(0,1.5707963267948966,0)),deltaTime) 
...
RootJoint.C0=Lerp(RootJoint.C0,cfMul(cf(0.3+0.3*sin((sine+1)*1),2+0.5*sin((sine+2)*2),0.3+0.3*sin((sine+1)*1)),angles(-2.181661564992912+0.08726646259971647*sin((sine+1)*2),0,3.141592653589793)),deltaTime)  RightHip.C0=Lerp(RightHip.C0,cfMul(cf(1,-1,0),angles(0,1.5707963267948966,0)),deltaTime)  LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-1,0.5,0),angles(-0.4363323129985824-0.10471975511965978*sin((sine+6)*2.5),-1.2217304763960306-0.10471975511965978*sin((sine+5)*4.5),0)),deltaTime)  Neck.C0=Lerp(Neck.C0,cfMul(cf(0,1,0),angles(-1.1344640137963142+0.06981317007977318*sin((sine+2)*3),0,3.141592653589793)),deltaTime)  LeftHip.C0=Lerp(LeftHip.C0,cfMul(cf(-1,-1,0),angles(0,-1.5707963267948966,0)),deltaTime)  RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(1,0.5,0),angles(-0.4363323129985824+0.10471975511965978*sin((sine+6)*3),1.2217304763960306+0.10471975511965978*sin((sine+5)*5),0)),deltaTime) 
end,
		jump = function()
			velYchg()
			local Vfw, Vrt = velbycfrvec()

LeftHip.C0=Lerp(LeftHip.C0,cfMul(cf(-1,-1,0),angles(0,-1.5707963267948966,0)),deltaTime)  Neck.C0=Lerp(Neck.C0,cfMul(cf(0,1,0),angles(-1.9198621771937625+0.10471975511965978*sin((sine+4)*2.5),0,3.141592653589793)),deltaTime)  RightHip.C0=Lerp(RightHip.C0,cfMul(cf(1,-1,0),angles(0,1.5707963267948966,0)),deltaTime)  LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-1,0.5,0),angles(-0.3490658503988659-0.03490658503988659*sin((sine+2)*4.5),-1.3089969389957472-0.10471975511965978*sin((sine+2)*3),0)),deltaTime)  RootJoint.C0=Lerp(RootJoint.C0,cfMul(cf(0,2,0.3),angles(-1.3089969389957472+0.05235987755982989*sin((sine+3)*3),0,3.141592653589793)),deltaTime)  RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(1,0.5,0),angles(-0.3490658503988659+0.03490658503988659*sin((sine+2)*4),1.3089969389957472+0.10471975511965978*sin((sine+2)*3.5),0)),deltaTime) 
end,
		fall = function()
			velYchg()
			local Vfw, Vrt = velbycfrvec()

LeftHip.C0=Lerp(LeftHip.C0,cfMul(cf(-1,-1,0),angles(0,-1.5707963267948966,0)),deltaTime)  Neck.C0=Lerp(Neck.C0,cfMul(cf(0,1,0),angles(-1.8325957145940461+0.10471975511965978*sin((sine+4)*2.5),0,3.141592653589793)),deltaTime)  RightHip.C0=Lerp(RightHip.C0,cfMul(cf(1,-1,0),angles(0,1.5707963267948966,0)),deltaTime)  LeftShoulder.C0=Lerp(LeftShoulder.C0,cfMul(cf(-1,0.5,0),angles(-0.3490658503988659-0.03490658503988659*sin((sine+2)*4.5),-1.3089969389957472-0.10471975511965978*sin((sine+2)*3),0)),deltaTime)  RootJoint.C0=Lerp(RootJoint.C0,cfMul(cf(0,2,0.3),angles(-1.5707963267948966+0.05235987755982989*sin((sine+3)*3),0,3.141592653589793)),deltaTime)  RightShoulder.C0=Lerp(RightShoulder.C0,cfMul(cf(1,0.5,0),angles(-0.3490658503988659+0.03490658503988659*sin((sine+2)*4),1.3089969389957472+0.10471975511965978*sin((sine+2)*3.5),0)),deltaTime) 
end
	})
